        ...
        <main className="login-form_container">
          <section className="login-form_login-section">
            ...
            >
              {({
                ...
                <form onSubmit={handleSubmit} className={"login-section_form"}>
                  <label htmlFor="email">
                    Correo electrónico
                    <input
                      type="email"
                  ...
                  <div className="login-section_password-wrapper">
                    ...
                    >
                      <Icon icon={seePassword ? "bx:show" : "bx:hide"}></Icon>
                    </button>
                  </div>
                  <Link
                    to="/forgotPassword"
            ...
            <GoogleLogin
              ...
              render={(renderProps) => (
                ...
                >
                  ...
                  <Icon icon={"grommet-icons:google"}></Icon>
                </button>
              )}
          ...
          <section className="login-form_create-account-section">
            <section className="create-account-section_col1">
              <img
                src="https://i.imgur.com/FA1ef4x.png"
                alt="Woman of color looking forwards"
              />
            </section>
