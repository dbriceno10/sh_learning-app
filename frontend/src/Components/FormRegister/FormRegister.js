...
const FormRegister = () => {
  ...
  const validateInputs = (valores) => {
    ...
    if (!valores.lastName) {
      ...
      errores.lastName = "El apellido solo puede contener espacios y letras";
    }
    if (!valores.email) {
      ...
      try {
        ...
        if (res.statusText === "OK") {
          ...
          MySwal.fire({
            ...
            icon: "success",
            title:
              "Felicitaciones! Te has registrado con éxito! Revisa tu email para confirmar tu cuenta!",
              ...
              <section className="register-form_role-section">
                ...
                <section className="role-section_roles-group">
                  <div>
                    ...
                    ></input>
                    <label
                      htmlFor="role-section_teacher"
                      className="role-section_label"
                    >
                      <div>
                        <img
                          src="https://i.imgur.com/5McpoQp.png"
                          alt="Man teacher standing and smiling"
                        />
                      </div>
                      <span>Profesor</span>
                      <Icon
                  ...
                  <div>
                    ...
                    ></input>
                    <label
                      htmlFor="role-section_student"
                      className="role-section_label"
                    >
                      <div>
                        <img
                          src="https://i.imgur.com/dsw43zw.png"
                          alt="Man teacher standing and smiling"
                        />
                      </div>
                      <Icon
