...
import {List, Datagrid, TextField, EditButton, DeleteButton,FileField, Edit, TextInput, ReferenceField,SimpleForm, Create,ReferenceArrayInput,SelectArrayInput} from 'react-admin';
    ...
    return(
        <List {...props}>
            <Datagrid >
                ...
                <FileField source="url" label='video' title="ver archivo" target="url"/>
